    'use strict';
    var reachApp = angular.module('app', ['ngRoute', 'ngAnimate', 'ngBackstretch', 'highcharts-ng', 'ngHolder', 'nvd3ChartDirectives', 'ui.knob', 'datatables', 'datatables.bootstrap', 'ui.bootstrap'])
    .config([
